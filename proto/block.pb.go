...
var file_proto_block_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x25, 0x0a, 0x0f, 0x41, 0x64,
	...
	,
...
var file_proto_block_proto_depIdxs = []int32{
	...
	0, // 1: proto.Kappa.AddBlock:input_type -> proto.AddBlockRequest
	3, // 2: proto.Kappa.GetBlock:input_type -> proto.GetBlockRequest
	1, // 3: proto.Kappa.AddBlock:output_type -> proto.AddBlockResponse
	4, // 4: proto.Kappa.GetBlock:output_type -> proto.GetBlockResponse
...
// KappaClient is the client API for Kappa service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type KappaClient interface {
	AddBlock(ctx context.Context, in *AddBlockRequest, opts ...grpc.CallOption) (*AddBlockResponse, error)
	GetBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetBlockResponse, error)
}

type kappaClient struct {
	cc grpc.ClientConnInterface
}

func NewKappaClient(cc grpc.ClientConnInterface) KappaClient {
	return &kappaClient{cc}
}

func (c *kappaClient) AddBlock(ctx context.Context, in *AddBlockRequest, opts ...grpc.CallOption) (*AddBlockResponse, error) {
	out := new(AddBlockResponse)
	err := c.cc.Invoke(ctx, "/proto.Kappa/AddBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kappaClient) GetBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetBlockResponse, error) {
	out := new(GetBlockResponse)
	err := c.cc.Invoke(ctx, "/proto.Kappa/GetBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// KappaServer is the server API for Kappa service.
type KappaServer interface {
	AddBlock(context.Context, *AddBlockRequest) (*AddBlockResponse, error)
	GetBlock(context.Context, *GetBlockRequest) (*GetBlockResponse, error)
}

// UnimplementedKappaServer can be embedded to have forward compatible implementations.
type UnimplementedKappaServer struct {
}

func (*UnimplementedKappaServer) AddBlock(context.Context, *AddBlockRequest) (*AddBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddBlock not implemented")
}
func (*UnimplementedKappaServer) GetBlock(context.Context, *GetBlockRequest) (*GetBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlock not implemented")
}

func RegisterKappaServer(s *grpc.Server, srv KappaServer) {
	s.RegisterService(&_Kappa_serviceDesc, srv)
}

func _Kappa_AddBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KappaServer).AddBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Kappa/AddBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KappaServer).AddBlock(ctx, req.(*AddBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Kappa_GetBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KappaServer).GetBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Kappa/GetBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KappaServer).GetBlock(ctx, req.(*GetBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Kappa_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.Kappa",
	HandlerType: (*KappaServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddBlock",
			Handler:    _Kappa_AddBlock_Handler,
		},
		{
			MethodName: "GetBlock",
			Handler:    _Kappa_GetBlock_Handler,
		},
	},
